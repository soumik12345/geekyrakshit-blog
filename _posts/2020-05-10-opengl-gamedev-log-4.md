...
First of all, we need to set `GLFW_RESIZABLE` to `GL_TRUE`. As of now, the heigh and width of the framebuffer are static and needs to be varied dynamically as the window is scaled. For this, we would need to write a callback for resizing:
...
Now instead of getting the framebuffer dimensions using `glfwGetFramebufferSize` and `glViewport`, we would use:
...
**Github Commit:** [https://github.com/soumik12345/OpenGL-Track/tree/e2214d43db9128976bb98ddd5ba3b73314e8582a](https://github.com/soumik12345/OpenGL-Track/tree/e2214d43db9128976bb98ddd5ba3b73314e8582a)
...
**Github Commit:** [https://github.com/soumik12345/OpenGL-Track/tree/fbc2e6a7068b62d38fb869c92a34681471e24e95](https://github.com/soumik12345/OpenGL-Track/tree/fbc2e6a7068b62d38fb869c92a34681471e24e95)
